...
exports.deleteValor = deleteValor;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, prisma.produto.delete({
                            where: {
                                cod: cod
                            }
                        })];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, 4, 5]);
                    return [4 /*yield*/, prisma.valor.delete({
                            where: {
                                id_valor: id_valor
                            }
                        })];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, 4, 5]);
                    return [4 /*yield*/, prisma.venda.delete({
                            where: {
                                id_venda: id_venda
                            }
                        })];
